...
class PlaceCardSec extends Component{
  constructor(props){
    super(props);     
    this.state={
  ...
  render(){    
  const {viewMode,onItemPressed,inSavePlace,image,inFindPlace,name,country,description}=this.props;
  const {popInAnim}=this.state;    
    return ( 
